...
export function createOpenClawTools(
  ...
  // Verantyx Commander Pattern: remove direct file access tools
  // when running in commander mode. The commander should delegate
  // file operations to worker agents via the orchestrator.
  if (process.env.VERANTYX_COMMANDER_MODE === "true") {
    ...
    return allTools.filter((tool) => !blockedTools.has(tool.name));
  }
