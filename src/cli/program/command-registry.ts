...
const coreEntries: CoreCliEntry[] = [
  {
    ...
    register: async ({ program }) => {
      ...
      mod.registerRoninSetupCli(program);
    },
  },
  {
    commands: [
  ...
  // Verantyx spatial memory commands
  {
    commands: [
      {
        name: "spatial",
        description: "Verantyx spatial memory management (front/near/mid/deep)",
        hasSubcommands: true,
      },
    ],
    register: async ({ program }) => {
  ...
  // Verantyx chat command
  {
    ...
    register: async ({ program }) => {
      const mod = await import("../verantyx-chat.js");
      mod.registerRoninChatCli(program);
    },
  },
  // Verantyx Exec (Fabric Piping)
  {
    commands: [
      {
        name: "exec",
        description: "Verantyx single shot execution with Fabric standard input pipeline support",
        hasSubcommands: false,
      },
    ],
    register: async ({ program }) => {
      const mod = await import("../verantyx-exec.js");
      mod.registerRoninExecCli(program);
    },
  },
  // Verantyx VFS commands
  {
    commands: [
      {
        name: "vfs",
    ...
    register: async ({ program }) => {
      const mod = await import("../verantyx-cli.js");
      mod.registerRoninVfsCli(program);
    },
  },
  // Verantyx Local LLM commands
  {
    commands: [
      {
        name: "locallm",
    ...
    register: async ({ program }) => {
      const mod = await import("../verantyx-cli.js");
      mod.registerRoninLocallmCli(program);
    },
  },
];
